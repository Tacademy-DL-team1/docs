# 건설 현장 안전고리 체결 판별 시스템 — 문서

건설 현장 CCTV 영상에서 작업자의 안전고리 체결 여부를 판별하는 딥러닝 프로젝트의 문서 저장소입니다. 최종 객체 탐지·인스턴스 분할 모델로 RF-DETR을 사용했으며, 이 저장소에서는 회의 기록, 최종 발표자료, 프로젝트 보고서와 실행 가이드를 관리합니다.
